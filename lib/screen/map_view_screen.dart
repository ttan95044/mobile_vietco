...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: const Text('Vietmap Flutter GL'), centerTitle: true),
      body: Stack(children: [
        VietmapGL(
            ...
            onPressed: () {
              if (isVector) {
                ...
                _mapController?.setStyle(
                    "https://maps.vietmap.vn/api/maps/google-satellite/styles.json?apikey=9cbf0bc15d3901b7e043d8f76be8d73f370a82fe629a2d46",
                    keepExistingAnnotations: true);
              } else {
                isVector = true;
                _mapController?.setStyle(
                    "https://maps.vietmap.vn/api/maps/google/styles.json?apikey=9cbf0bc15d3901b7e043d8f76be8d73f370a82fe629a2d46");
              }
            },
            child: Icon(Icons.center_focus_strong),
          ),
